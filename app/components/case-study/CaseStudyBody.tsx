        ...
        <section className="bg-white py-20 px-6 md:px-12 lg:px-20">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-24">
                ...
                <div className="lg:w-3/4 text-lg text-gray-700 leading-relaxed space-y-12">
                    ...
                    {/* The CEEK Approach */}
                    <div>
                        <h3 className="text-2xl font-bold text-black uppercase mb-4">THE CEEK APPROACH</h3>
                        <p className="mb-6">
                            By closely monitoring trends, algorithms, and audience preferences, the CEEK team tailored their <span className="font-bold text-black">content creation</span> to exponentially grow Mogu Mogu’s TikTok and Instagram accounts.
                        </p>
                        <p className="mb-6">
                            The CEEK team adapted viral content to Mogu Mogu’s fun and playful brand personality, gathering millions of impressions and meaningful interactions on Mogu Mogu’s <span className="font-bold text-black">social media</span> channels. The CEEK team used these impressions to their advantage, launching a META re-marketing strategy with a 270% ROI.
                        </p>
                        <p className="mb-6">
